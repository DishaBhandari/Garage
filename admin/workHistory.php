...
$date= str_replace(" "," T",$date);
        ...
        $sql = "SELECT work_details.id, work_details.order_id, work_details.client_id, work_details.vehicle_no, work_details.services, work_details.other_info, work_details.service_date, work_details.actual_charge, work_details.billing_charge,work_details.invoice_document, work_details.status,client_details.id as cid, client_details.name
    ...
    <section class="content">
        <div class="container">
            ...
            <div class="row">
            <a  href="listClient.php" type="button" class="btn btn-success status ml-2 mb-3" >Add Work</a>
                <div class="col-12 ">
                <table id="example1" class="table table-striped table-bordered table-responsive" style="width:100%">
                        ...
                        ?>                         
                            <tr> 
                                ...
                                <td>
                                <?php if($row["invoice_document"] != NULL){ ?>
                                    <a href="../invoice/<?= $row["invoice_document"] ?>"  style ="padding: 0.27rem 1.7rem;" target="_blank"type="button" class=" mb-1 btn btn-secondary "  >Show</a>
                                <?php } ?>
                               <a href="generate_bill?q=<?= $id ?>"  style ="padding: 0.27rem 1rem;" type="button" class=" mb-1 btn btn-secondary "  >Generate</a>
                               <?php if($row["invoice_document"] != NULL){ ?>                               
                               <a href="invoice_mail.php?q1=<?=$id?>&q2=<?=$cid?>"  style ="padding: 0.27rem 2.1rem;" type="button" class=" mb-1 btn btn-secondary "  >Mail</a>
                               <?php } ?>
                            </td>
        ...
        <input type="hidden" id="e_client_id" name="e_client_id">
                                ...
                                <div class="form-group">
                                   ...
                                   <div class="row">
                                    ...
                                    <input type="checkbox" class="mr-1 services" name="e_services[]" data-value="'.$data2['service_name'].'" value="'.$data2['id'].'" >
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".edit", function() { 
            ...
            var c_id = $(this).parent().prev().prev().prev().prev().prev().prev().prev().prev().prev().html(); 
            var vehicle = $(this).parent().prev().prev().prev().prev().prev().prev().prev().prev().html();
            var name = $(this).parent().prev().prev().prev().prev().prev().prev().prev().html();
            var service = $(this).parent().prev().prev().prev().prev().prev().prev().html();
            var o_info = $(this).parent().prev().prev().prev().prev().prev().html();
            var service_date = $(this).parent().prev().prev().prev().prev().html().replace(' ','T');
            var a_charge = $(this).parent().prev().prev().prev().html().substring(2);
            var b_charge = $(this).parent().prev().prev().html().substring(2);
            ...
            var service = $.trim(service)+' ';
            var service_arr = service.split(", ");

            $.each(service_arr, function(index, item){
